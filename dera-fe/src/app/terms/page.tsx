  ...
  return (
    <Container>
      ...
      <p>
        ...
        determine the rules of the Service and to clarify the legal relationship
        between the entity using the Service and the Company. {productName}.co.
        (“Company”) operates web pages located at{' '}
        <a href={`https://${domain}`}>{domain}</a> (&ldquo;Website&ldquo;) and
        offers Service (as defined below in Section 2).The Service is dedicated
        to the professional entities to help them to conduct their business.
        Using the Website and/or the Service in any manner, also by going
        through the Account registration process, the User or the Guest declares
        that (i) he/she has read, understood and accepts the provisions of the
        Terms and Privacy Policy, (ii) his/her age and legal capacity enables to
        conclude an agreement with the Company, (iii) he/she has the right to
        act on behalf of the entity which he/she represents and his/her
      ...
      <p>
        <b>Account</b> – means individualized panel serving the User to exploit
      ...
      <p>
        <b>API</b> – means {productName} application programming interface to be
        integrated with the User’s software.
      </p>
      <p>
        <b>Company</b> – means {productName}.co,
      </p>
      <p>
        <b>Content</b> – means the contents such as texts, pictures and other,
        which the Guest, or the User publishes, presents or sends on the Website
        or with the use of Service.
      </p>
      <p>
      ...
      <p>
        ...
        enables the access to the Account and is the sequence of signs possibly
        to entry by using the keyboard of the computer or Mobile Device, which
      ...
      <p>
        ...
        following address:{' '}
        <a href={`https://${domain}/terms`}>https://{domain}/terms</a>.
      </p>
      <p>
      ...
      <p>
        Above mentioned definitions retain their meaning regardless of whether
        they are expressed in the singular or the plural.
      </p>
      <h3>3. General Rules</h3>
      <p>
        Using the Service means full acceptance of the Terms. The Terms applies
        to relations between the Company and the Guest or the User only. If the
        Service and/or the Website introduces the possibility of providing
        services by other entities, they will be provided on the basis of
        regulations shared by these entities and only these entities will be
        responsible for the execution of the services, except the content of the
        Terms clearly and unambiguously indicates otherwise. Each entity using
        the Service and/or the Website is obliged to use it in accordance with
        its destiny resulting from the Terms. Using the Website is permissible
        provided that the Device meets jointly the following minimum technical
        requirements:
      </p>
      <ul>
        ...
        <li>
          ...
          Google Chrome, (ii) Opera, (iii) Firefox, (iv) Safari, (v) Microsoft
          Edge,
        </li>
        <li>
      ...
      <p>
        ...
        providing other personal email and Password. When you create an Account
        you should provide us with accurate, complete, and current information
        at all times. Inaccurate, incomplete, or obsolete information may result
        in the immediate termination of your account on the Website and Service.
        You are responsible for maintaining the confidentiality of your Account
        and Password, including but not limited to the restriction of access to
        your Device or Mobile Device and/or Account. You agree to accept
        responsibility for any and all activities or actions that occur under
        your Account and/or Password, whether your Password is with our Website
        and Service or a third-party service. You must notify us immediately
        upon becoming aware of any breach of security or unauthorized use of
        your Account. You may not use as a username the name of another person
        or entity or that is not lawfully available for use, a name or trademark
      ...
      <h3>6. Contests, Sweepstakes and Promotions</h3>
      <p>
        Any contests, sweepstakes or other promotions (collectively
        “Promotion(s)”) made available through Service or Website may be
        governed by rules that are separate from these Terms (in particular set
        out in the Agreement, if concluded). If you participate in any
        Promotions, please review the applicable rules as well as our Privacy
        Policy. If the rules for a Promotion conflict with these Terms,
      ...
      <p>
        ...
        select when purchasing a Subscription. At the end of each Billing Cycle,
      ...
      <p>
        ...
        will become effective at the end of the then-current Billing Cycle. The
      ...
      <p>
        ...
        other material (“Content”). You are responsible, in particular to your
        customers, for Content that you post on or through Service including its
        legality, reliability, and appropriateness. By posting Content on or
        through Service or Website, You represent and warrant that: (i) Content
        is yours (you own it) and/or you have the right to use it and the right
        to grant us the rights and license as provided in these Terms, and (ii)
        that the posting of your Content on or through Service does not violate
        the privacy rights, publicity rights, copyrights, contract rights or any
        other rights of any person or entity. We reserve the right to terminate
        the Account of any User found to be infringing on a copyright. You
        retain any and all of your rights to any Content you submit, post or
        display on or through Service or Website and you are responsible for
      ...
      <ul>
        ...
        <li>
          ...
          or enjoyment of Service or Website, or which, as determined by us, may
          harm or offend Company or Users of Service or Website or expose them
          to liability.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          damage, or impair Service or Website or interfere with any other
          party’s use of Service, including their ability to engage in real time
          activities through Service or Website,
        </li>
        <li>
          use any robot, spider, or other automatic device, process, or means to
          access Service or Website for any purpose, including monitoring or
          copying any of the material on Service or Website,
        </li>
        <li>
          use any manual process to monitor or copy any of the material on
          Service or Website or for any other unauthorized purpose without our
        ...
        <li>
          ...
          disrupt any parts of Service or Website, the server on which Service
          or Website is stored, or any server, computer, or database connected
          to Service or Website,
        </li>
        <li>
      ...
      <p>
        ...
        track and monitor the use of our Service and Website. This data is
      ...
      <p>
        ...
        the Company and its licensors. The Service and the Website are protected
        ...
        Company. The Guest and the User by using the Service do not acquire any
        rights to the Intellectual Property. It is prohibited to use the
        Intellectual Property for purposes other than those resulting from the
        authorized personal use referred to in the Article 23 of the Act of
        February 4, 1994 on Copyright and Related Rights. Upon purchase of a
      ...
      <p>
        ...
        thereof. The User is not entitled to create and/or publish APIs or
        otherwise proxying access to the Service or the Website nor is allowed
        to use the Service or the Website in an automated manner (that is by
      ...
      <p>
        ...
        to respond to any claim that Content posted with the use of the Service
        or on the Website infringes on the copyright or other intellectual
      ...
      <h3>15. DMCA Notice and Procedure for Copyright Infringement Claims</h3>
      <p>
      ...
      <p>
        The Company tries – to the best of its ability – to support the Guests
        and Users in solving their problems related to functioning of the
        Service, as well as undertakes actions to improve the quality of the
        Service’s functioning and the provision of the Service based on the
        comments submitted by these entities.
      </p>
      <p>
        ...
        acquire or assert any intellectual property right or other right, title
        or interest in or to the Feedback; (ii) Company may have development
      ...
      <h3>17. Links to Other Websites</h3>
      <p>
        Our Service and/or Website may contain links to Other Websites that are
        ...
        practices of any Other Websites. We do not warrant the offerings of any
        of these entities/individuals or Other Websites. YOU ACKNOWLEDGE AND
        ...
        SERVICES AVAILABLE ON OR THROUGH ANY OTHER WEBSITES. WE STRONGLY ADVISE
        YOU TO READ THE TERMS OF SERVICE AND PRIVACY POLICIES OF ANY OTHER
        WEBSITES THAT YOU VISIT.
      </p>
      <h3>18. Disclaimer of Warranty</h3>
      <p>
        THE SERVICES ARE PROVIDED BY COMPANY ON AN “AS IS” AND “AS AVAILABLE”
        ...
        THAT YOUR USE OF THE SERVICES, THEIR CONTENT, AND ANY SERVICES OR ITEMS
      ...
      <p>
        The Company shall not be liable for the consequences of complying with
        the content of tips, articles or other publications on the Website or
        the Service, including the content provided by the AI computer. You
        acknowledge that the AI computer that provides the content in the
        Service and/or the Website is not the expert and may be mistaken and you
        cannot rely on its answers or advice. In particular it cannot replace
        any professional recommendation. The Company shall not be liable to the
        customers of the User for the use of the Service and the Content
        provided by the Service to the User’s customers.The Company shall not be
        liable for the consequences of installing or sending any malicious
        software, phishing or any other practises undertaken by other entities
        to the Service. The Company shall not be liable for any breaks in the
        operation of the Service. The Company shall not be liable for the
        consequences of phenomena known as force majeure, including in
        particular power outages, fires, atmospheric phenomena, wars, riots,
        strikes and other similar events that are not affected by the Company.
        ...
        FOR PERSONAL INJURY OR PROPERTY DAMAGE, ARISING FROM THESE TERMS AND ANY
        VIOLATION BY YOU OF ANY FEDERAL, STATE, OR LOCAL LAWS, STATUTES, RULES,
        OR REGULATIONS, EVEN IF COMPANY HAS BEEN PREVIOUSLY ADVISED OF THE
        ...
        PAID FOR THE SERVICES, AND UNDER NO CIRCUMSTANCES WILL THERE BE
      ...
      <h3>20. The Guest’s/User’s Liability</h3>
      <p>
        The Guest and/or User is fully liable for the consequences of authorised
        or unauthorised distribution of any content available on the Website or
        the Service. This applies in particular to the Intellectual Property.
        The liability includes, in particular, Company's release from any claims
        in this respect if such are against Company. The User is solely liable
        for any Content published, presented, sent or in any other way provided
        during the use of Service to the User’s customers.
      </p>
      <h3>21. Service breaks</h3>
      <p>
        The Company does not guarantee the permanent accessibility of the
        Service or the Website. The Company reserves the right to introduce a
        break in the operation of the Website or the Service or their certain
        functionalities. If there is an intention to implement a break, the
        Company will notify about it by posting relevant information or a
        massage on the Website or via the email provided when setting-up the
        Account at least 3 days before the date of planned break. In the event
        of unintended breaks in the operation of the Website or the Service or
        their certain functionalities, the Company will immediately notify about
        it by posting a relevant information or message on the Website or via
        the email provided when setting-up the Account. Acceptance of the
        Regulations means also giving an approval for the Services being not
        100% reliable.
      </p>
      <h3>22. Personal Data Protection and Security</h3>
      <p>
        ...
        information about the protection of personal data can be found in the
        Privacy Policy. The Company shall not be liable for the personal data
        protection of the User’s customers that use the Service. The Company
        shall not be liable for the contents and rules of personal data
        protection and privacy on the Other Websites, including those to which
        the Links refer. The Company shall not be liable for the damages caused
        by browsing the Other Websites or posting any personal data or other
        information on them. The Company recommends reading the rules of
        personal data protection and privacy on the Other Websites, including
        those to which the Links refer, before starting using them, in
      ...
      <p>
        ...
        use Service. In case of any discrepancies between these Terms and the
        Agreement (if concluded), the provisions of the Agreement shall be
        applicable. The aforementioned sentence refers also to the amendments of
        these Terms introduced in the Agreement.
      </p>
      <h3>27. Waiver And Severability</h3>
      <p>
